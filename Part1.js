...
/* 
 ...
 // Block scope: A variable when declared inside the if or wwitch conditions or inside for or while loop, are accessible within that particular condition or loop.
...
// these are 7 types of primitive datatype
...
// so js gives us three forma of statements
// 1) if statemant
let condition = true;
if (condition) {
  // do this
...
// 6) For Loop : loop a block of code x no. of times
for (let i = 0; i <= 10; i++) {
